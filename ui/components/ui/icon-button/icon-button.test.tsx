...
describe('IconButton', () => {
  ...
  it('renders tooltip for long label', () => {
    render(<IconButton {...defaultProps} label="This is a very long button label that should trigger tooltip" />);

    // Find the text inside a tooltip
    const tooltipText = screen.getByText('This is a very long button label that should trigger tooltip');
    expect(tooltipText).toBeInTheDocument();
  });

  it('sets aria-label from label prop by default', () => {
    render(<IconButton {...defaultProps} />);
  ...
  it('uses custom ariaLabel prop when provided', () => {
    render(<IconButton {...defaultProps} ariaLabel="Custom aria label" />);
  ...
  it('passes through additional props to ButtonBase', () => {
    render(<IconButton {...defaultProps} width={BlockSize.Full} data-testid="custom-test-id" />);
  ...
  it('renders children correctly', () => {
    const { container } = render(
      <IconButton {...defaultProps} Icon={<div className="custom-icon">Icon</div>} />
    );
